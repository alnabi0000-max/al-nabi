      ...
      <div className="grid gap-3 md:grid-cols-2">
        <div className="space-y-2">
          <textarea
            ...
            maxLength={500}
            rows={2}
            className="w-full resize-none rounded-xl border border-white/10 bg-black/40 px-3 py-2 text-xs text-white placeholder:text-white/30 focus:border-fuchsia-400/40 focus:outline-none"
          />
          <button
            type="button"
        ...
        <div className="space-y-2">
          <textarea
            ...
            maxLength={240}
            rows={2}
            className="w-full resize-none rounded-xl border border-white/10 bg-black/40 px-3 py-2 text-xs text-white placeholder:text-white/30 focus:border-amber-400/40 focus:outline-none"
          />
          <button
            type="button"
